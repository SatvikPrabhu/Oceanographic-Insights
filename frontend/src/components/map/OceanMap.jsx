...
import MpaSanctuaryLayer from "./MpaSanctuaryLayer.jsx";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {layers.mpa && <MpaSanctuaryLayer isVisible={layers.mpa} />}
        {layers.hotspots && <HotspotLayer hotspots={hotspots} onSelectHotspot={onSelectHotspot} />}
